 ...
 */
package com.mycompany.proyecto001dtorresyjguerrero;

/**
 *
 * @author Pc Daniel
 */
public class Proyecto001DTorresyJGuerrero {

    public static void main(String[] args) {
        System.out.println("Proyecto001");
        var deporte1 = new Deportes();
        var deporte2 = new Deportes();
        var deporte3 = new Deportes();
        ...
        var zapato2 = new Zapatos();
        var zapato3 = new Zapatos();
        ...
        var video1 = new Videojuegos();
        var video2 = new Videojuegos();
        var video3 = new Videojuegos();
        ...
        var celu1 = new Celulares();
        var celu2 = new Celulares();
        var celu3 = new Celulares();
        ...
        var bebida1 = new Bebidas();
        var bebida2 = new Bebidas();
        var bebida3 = new Bebidas();
